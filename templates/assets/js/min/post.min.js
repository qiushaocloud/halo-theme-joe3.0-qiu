const postContext={limited:!1,initCopy(){if("false"!==PageAttrs.metas_enable_copy&&ThemeConfig.enable_copy){const l=location.href,s=$(".joe_detail").attr("data-author"),r=$(".joe_detail .joe_detail__title").text();$(".joe_detail__article").on("copy",function(e){var t=window.getSelection(),o=t.toString().replace(/<已自动折叠>/g,""),a=(ThemeConfig.enable_copy_right_text?ThemeConfig.copy_right_text||`\r
\r
====================================\r
文章作者： ${s}\r
